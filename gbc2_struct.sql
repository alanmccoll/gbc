...
--
-- Host: localhost:3306
-- Generation Time: Jan 05, 2020 at 08:00 AM
...
--
-- Table structure for table `bootstrap_simple_carousel`
--

CREATE TABLE `bootstrap_simple_carousel` (
  `cid` int(10) UNSIGNED NOT NULL,
  `image_id` int(10) UNSIGNED NOT NULL,
  `image_alt` varchar(255) CHARACTER SET ascii NOT NULL DEFAULT '',
  `image_title` varchar(255) CHARACTER SET ascii NOT NULL DEFAULT '',
  `caption_title` varchar(100) CHARACTER SET ascii NOT NULL DEFAULT '',
  `caption_text` varchar(255) CHARACTER SET ascii NOT NULL DEFAULT '',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  `weight` int(10) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Items of the carousel module.';
...
--
-- Table structure for table `inline_block_usage`
--
...
--
-- Table structure for table `media_revision__field_date_preached`
--

CREATE TABLE `media_revision__field_date_preached` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  `langcode` varchar(32) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code for this data item.',
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_date_preached_value` varchar(20) NOT NULL COMMENT 'The date value.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Revision archive storage for media field field_date…';

-- --------------------------------------------------------

--
-- Table structure for table `media_revision__field_letter_date`
--

CREATE TABLE `media_revision__field_letter_date` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  `langcode` varchar(32) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code for this data item.',
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_letter_date_value` varchar(20) NOT NULL COMMENT 'The date value.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Revision archive storage for media field field_letter_date.';
...
--
-- Table structure for table `media_revision__field_media_file`
--

CREATE TABLE `media_revision__field_media_file` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  `langcode` varchar(32) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code for this data item.',
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_media_file_target_id` int(10) UNSIGNED NOT NULL COMMENT 'The ID of the file entity.',
  `field_media_file_display` tinyint(3) UNSIGNED DEFAULT '1' COMMENT 'Flag to control whether this file should be displayed when viewing content.',
  `field_media_file_description` text COMMENT 'A description of the file.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Revision archive storage for media field field_media_file.';

-- --------------------------------------------------------

--
-- Table structure for table `media_revision__field_media_file_1`
--

CREATE TABLE `media_revision__field_media_file_1` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  `langcode` varchar(32) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code for this data item.',
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_media_file_1_target_id` int(10) UNSIGNED NOT NULL COMMENT 'The ID of the file entity.',
  `field_media_file_1_display` tinyint(3) UNSIGNED DEFAULT '1' COMMENT 'Flag to control whether this file should be displayed when viewing content.',
  `field_media_file_1_description` text COMMENT 'A description of the file.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Revision archive storage for media field field_media_file_1.';

-- --------------------------------------------------------

--
-- Table structure for table `media_revision__field_media_file_2`
--

CREATE TABLE `media_revision__field_media_file_2` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  `langcode` varchar(32) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code for this data item.',
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_media_file_2_target_id` int(10) UNSIGNED NOT NULL COMMENT 'The ID of the file entity.',
  `field_media_file_2_display` tinyint(3) UNSIGNED DEFAULT '1' COMMENT 'Flag to control whether this file should be displayed when viewing content.',
  `field_media_file_2_description` text COMMENT 'A description of the file.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Revision archive storage for media field field_media_file_2.';
...
--
-- Table structure for table `media_revision__field_preacher`
--

CREATE TABLE `media_revision__field_preacher` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  `langcode` varchar(32) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code for this data item.',
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_preacher_value` varchar(255) NOT NULL,
  `field_preacher_format` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Revision archive storage for media field field_preacher.';

-- --------------------------------------------------------

--
-- Table structure for table `media_revision__field_service_date`
--

CREATE TABLE `media_revision__field_service_date` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  `langcode` varchar(32) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code for this data item.',
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_service_date_value` varchar(20) NOT NULL COMMENT 'The date value.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Revision archive storage for media field field_service_date.';

-- --------------------------------------------------------

--
-- Table structure for table `media__field_date_preached`
--

CREATE TABLE `media__field_date_preached` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  ...
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_date_preached_value` varchar(20) NOT NULL COMMENT 'The date value.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for media field field_date_preached.';

-- --------------------------------------------------------

--
-- Table structure for table `media__field_letter_date`
--

CREATE TABLE `media__field_letter_date` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  ...
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_letter_date_value` varchar(20) NOT NULL COMMENT 'The date value.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for media field field_letter_date.';
...
--
-- Table structure for table `media__field_media_file`
--

CREATE TABLE `media__field_media_file` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  ...
  `field_media_file_display` tinyint(3) UNSIGNED DEFAULT '1' COMMENT 'Flag to control whether this file should be displayed when viewing content.',
  `field_media_file_description` text COMMENT 'A description of the file.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for media field field_media_file.';

-- --------------------------------------------------------

--
-- Table structure for table `media__field_media_file_1`
--

CREATE TABLE `media__field_media_file_1` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  ...
  `field_media_file_1_display` tinyint(3) UNSIGNED DEFAULT '1' COMMENT 'Flag to control whether this file should be displayed when viewing content.',
  `field_media_file_1_description` text COMMENT 'A description of the file.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for media field field_media_file_1.';

-- --------------------------------------------------------

--
-- Table structure for table `media__field_media_file_2`
--

CREATE TABLE `media__field_media_file_2` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  ...
  `field_media_file_2_display` tinyint(3) UNSIGNED DEFAULT '1' COMMENT 'Flag to control whether this file should be displayed when viewing content.',
  `field_media_file_2_description` text COMMENT 'A description of the file.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for media field field_media_file_2.';
...
--
-- Table structure for table `media__field_preacher`
--

CREATE TABLE `media__field_preacher` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  ...
  `field_preacher_value` varchar(255) NOT NULL,
  `field_preacher_format` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for media field field_preacher.';

-- --------------------------------------------------------

--
-- Table structure for table `media__field_service_date`
--

CREATE TABLE `media__field_service_date` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to',
  ...
  `delta` int(10) UNSIGNED NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_service_date_value` varchar(20) NOT NULL COMMENT 'The date value.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Data storage for media field field_service_date.';
...
--
-- Table structure for table `old_099575menu_link_content`
--

CREATE TABLE `old_099575menu_link_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `bundle` varchar(32) CHARACTER SET ascii NOT NULL,
  `uuid` varchar(128) CHARACTER SET ascii NOT NULL,
  `langcode` varchar(12) CHARACTER SET ascii NOT NULL
...
--
-- Table structure for table `old_099575menu_link_content_data`
--

CREATE TABLE `old_099575menu_link_content_data` (
  `id` int(10) UNSIGNED NOT NULL,
  `bundle` varchar(32) CHARACTER SET ascii NOT NULL,
  `langcode` varchar(12) CHARACTER SET ascii NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `old_5dfdee_url_alias`
--

CREATE TABLE `old_5dfdee_url_alias` (
...
--
-- Table structure for table `old_5dff44_url_alias`
--

CREATE TABLE `old_5dff44_url_alias` (
  `pid` int(10) UNSIGNED NOT NULL COMMENT 'A unique path alias identifier.',
  `source` varchar(255) NOT NULL DEFAULT '' COMMENT 'The Drupal path this alias is for. e.g. node/12.',
  `alias` varchar(255) NOT NULL DEFAULT '' COMMENT 'The alias for this path. e.g. title-of-the-story.',
  `langcode` varchar(12) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The language code this alias is for. if ''und'', the alias will be used for unknown languages. Each Drupal path can have an alias for each supported language.'
...
--
-- Table structure for table `old_bb3251taxonomy_term_data`
--

CREATE TABLE `old_bb3251taxonomy_term_data` (
...
--
-- Table structure for table `old_bb3251taxonomy_term_field_data`
--

CREATE TABLE `old_bb3251taxonomy_term_field_data` (
  `tid` int(10) UNSIGNED NOT NULL,
  `vid` varchar(32) CHARACTER SET ascii NOT NULL COMMENT 'The ID of the target entity.',
  `langcode` varchar(12) CHARACTER SET ascii NOT NULL,
  `status` tinyint(4) NOT NULL,
...
--
-- Table structure for table `old_bb3251taxonomy_term__parent`
--

CREATE TABLE `old_bb3251taxonomy_term__parent` (
  `bundle` varchar(128) CHARACTER SET ascii NOT NULL DEFAULT '' COMMENT 'The field instance bundle to which this row belongs, used when deleting a field instance',
  `deleted` tinyint(4) NOT NULL DEFAULT '0' COMMENT 'A boolean indicating whether this data item has been deleted',
  `entity_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity id this data is attached to',
  `revision_id` int(10) UNSIGNED NOT NULL COMMENT 'The entity revision id this data is attached to, which for an unversioned entity type is the same as the entity id',
...
--
-- Indexes for table `bootstrap_simple_carousel`
--
ALTER TABLE `bootstrap_simple_carousel`
  ADD PRIMARY KEY (`cid`);
...
--
-- Indexes for table `inline_block_usage`
--
ALTER TABLE `inline_block_usage`
  ADD PRIMARY KEY (`block_content_id`),
  ADD KEY `type_id` (`layout_entity_type`,`layout_entity_id`);
...
--
-- Indexes for table `media_revision__field_date_preached`
--
ALTER TABLE `media_revision__field_date_preached`
  ADD PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_date_preached_value` (`field_date_preached_value`);

--
-- Indexes for table `media_revision__field_letter_date`
--
ALTER TABLE `media_revision__field_letter_date`
  ADD PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_letter_date_value` (`field_letter_date_value`);
...
--
-- Indexes for table `media_revision__field_media_file`
--
ALTER TABLE `media_revision__field_media_file`
  ADD PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_media_file_target_id` (`field_media_file_target_id`);

--
-- Indexes for table `media_revision__field_media_file_1`
--
ALTER TABLE `media_revision__field_media_file_1`
  ADD PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_media_file_1_target_id` (`field_media_file_1_target_id`);

--
-- Indexes for table `media_revision__field_media_file_2`
--
ALTER TABLE `media_revision__field_media_file_2`
  ADD PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_media_file_2_target_id` (`field_media_file_2_target_id`);
...
--
-- Indexes for table `media_revision__field_preacher`
--
ALTER TABLE `media_revision__field_preacher`
  ADD PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_preacher_format` (`field_preacher_format`(191));

--
-- Indexes for table `media_revision__field_service_date`
--
ALTER TABLE `media_revision__field_service_date`
  ADD PRIMARY KEY (`entity_id`,`revision_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_service_date_value` (`field_service_date_value`);

--
-- Indexes for table `media__field_date_preached`
--
ALTER TABLE `media__field_date_preached`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_date_preached_value` (`field_date_preached_value`);
...
--
-- Indexes for table `media__field_letter_date`
--
ALTER TABLE `media__field_letter_date`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_letter_date_value` (`field_letter_date_value`);
...
--
-- Indexes for table `media__field_media_file`
--
ALTER TABLE `media__field_media_file`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_media_file_target_id` (`field_media_file_target_id`);
...
--
-- Indexes for table `media__field_media_file_1`
--
ALTER TABLE `media__field_media_file_1`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_media_file_1_target_id` (`field_media_file_1_target_id`);
...
--
-- Indexes for table `media__field_media_file_2`
--
ALTER TABLE `media__field_media_file_2`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_media_file_2_target_id` (`field_media_file_2_target_id`);
...
--
-- Indexes for table `media__field_preacher`
--
ALTER TABLE `media__field_preacher`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_preacher_format` (`field_preacher_format`(191));
...
--
-- Indexes for table `media__field_service_date`
--
ALTER TABLE `media__field_service_date`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `bundle` (`bundle`),
  ADD KEY `revision_id` (`revision_id`),
  ADD KEY `field_service_date_value` (`field_service_date_value`);
...
--
-- Indexes for table `old_099575menu_link_content`
--
ALTER TABLE `old_099575menu_link_content`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `menu_link_content_field__uuid__value` (`uuid`);

--
-- Indexes for table `old_099575menu_link_content_data`
--
ALTER TABLE `old_099575menu_link_content_data`
  ADD PRIMARY KEY (`id`,`langcode`),
  ADD KEY `menu_link_content_field__link__uri` (`link__uri`(30)),
  ADD KEY `menu_link_content__id__default_langcode__langcode` (`id`,`default_langcode`,`langcode`),
  ADD KEY `menu_link_content__enabled_bundle` (`enabled`,`bundle`,`id`);
...
--
-- Indexes for table `old_5dfdee_url_alias`
--
ALTER TABLE `old_5dfdee_url_alias`
  ADD PRIMARY KEY (`pid`),
  ADD KEY `alias_langcode_pid` (`alias`(191),`langcode`,`pid`),
  ADD KEY `source_langcode_pid` (`source`(191),`langcode`,`pid`);

--
-- Indexes for table `old_5dff44_url_alias`
--
ALTER TABLE `old_5dff44_url_alias`
  ADD PRIMARY KEY (`pid`),
  ADD KEY `alias_langcode_pid` (`alias`(191),`langcode`,`pid`),
  ADD KEY `source_langcode_pid` (`source`(191),`langcode`,`pid`);

--
-- Indexes for table `old_bb3251taxonomy_term_data`
--
ALTER TABLE `old_bb3251taxonomy_term_data`
  ADD PRIMARY KEY (`tid`),
  ADD UNIQUE KEY `taxonomy_term_field__uuid__value` (`uuid`),
  ADD KEY `taxonomy_term_field__vid__target_id` (`vid`);

--
-- Indexes for table `old_bb3251taxonomy_term_field_data`
--
ALTER TABLE `old_bb3251taxonomy_term_field_data`
...
--
-- Indexes for table `old_bb3251taxonomy_term__parent`
--
ALTER TABLE `old_bb3251taxonomy_term__parent`
  ADD PRIMARY KEY (`entity_id`,`deleted`,`delta`,`langcode`),
  ADD KEY `revision_id` (`revision_id`),
...
--
ALTER TABLE `block_content_revision`
  MODIFY `revision_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `bootstrap_simple_carousel`
--
ALTER TABLE `bootstrap_simple_carousel`
...
--
ALTER TABLE `media`
  MODIFY `mid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `media_revision`
--
ALTER TABLE `media_revision`
  MODIFY `vid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `menu_link_content_revision`
  MODIFY `revision_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `menu_tree`
--
ALTER TABLE `menu_tree`
  MODIFY `mlid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'The menu link ID (mlid) is the integer primary key.', AUTO_INCREMENT=249;
--
...
--
ALTER TABLE `node_revision`
  MODIFY `vid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `old_099575menu_link_content`
--
ALTER TABLE `old_099575menu_link_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `old_5dfdee_url_alias`
--
ALTER TABLE `old_5dfdee_url_alias`
  MODIFY `pid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'A unique path alias identifier.', AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `old_5dff44_url_alias`
--
ALTER TABLE `old_5dff44_url_alias`
  MODIFY `pid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'A unique path alias identifier.', AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `old_bb3251taxonomy_term_data`
--
ALTER TABLE `old_bb3251taxonomy_term_data`
...
--
ALTER TABLE `path_alias_revision`
  MODIFY `revision_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `queue`
--
ALTER TABLE `queue`
  MODIFY `item_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique item ID.', AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `sequences`
--
ALTER TABLE `sequences`
  MODIFY `value` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'The value of the sequence.', AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `watchdog`
  MODIFY `wid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key: Unique watchdog event ID.', AUTO_INCREMENT=3752;
